...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.apply {
            ...
            fragmentNavigationObservable.value = Event(FragmentNavigationEvents.HOME_FRAGMENT)
        }
    }
        ...
        event.getContentIfNotHandled()?.let {
            when (it) {
                ...
                FragmentNavigationEvents.HOME_FRAGMENT -> addOrReplaceFragment(
                    ...
                    replace = true,
                    fragmentTag = VehicleListFragment.TAG
                )
                FragmentNavigationEvents.NEW_VEHICLE_FRAGMENT -> addOrReplaceFragment(
                    R.id.cl_container,
                    VehicleFragment.newInstance(),
                    addToBackStack = true,
                    replace = true,
                    fragmentTag = VehicleFragment.TAG
                )
            }
        }
    }
